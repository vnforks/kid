...
GO=go
DELVE=dlv
LDFLAGS += -X "github.com/vnforks/kid/v5/model.BuildNumber=$(BUILD_NUMBER)"
LDFLAGS += -X "github.com/vnforks/kid/v5/model.BuildDate=$(BUILD_DATE)"
LDFLAGS += -X "github.com/vnforks/kid/v5/model.BuildHash=$(BUILD_HASH)"
LDFLAGS += -X "github.com/vnforks/kid/v5/model.BuildHashEnterprise=$(BUILD_HASH_ENTERPRISE)"
LDFLAGS += -X "github.com/vnforks/kid/v5/model.BuildEnterpriseReady=$(BUILD_ENTERPRISE_READY)"
...
debug-server: start-docker ## Compile and start server using delve.
	...
	$(DELVE) debug $(PLATFORM_FILES) --build-flags="-ldflags '\
		-X github.com/vnforks/kid/v5/model.BuildNumber=$(BUILD_NUMBER)\
		-X \"github.com/vnforks/kid/v5/model.BuildDate=$(BUILD_DATE)\"\
		-X github.com/vnforks/kid/v5/model.BuildHash=$(BUILD_HASH)\
		-X github.com/vnforks/kid/v5/model.BuildHashEnterprise=$(BUILD_HASH_ENTERPRISE)\
		-X github.com/vnforks/kid/v5/model.BuildEnterpriseReady=$(BUILD_ENTERPRISE_READY)'"
