...
const (
	...
	ERROR_EVT_INVALID_CLASS_PATH                                              syscall.Errno = 15000
	...
	ERROR_EVT_CLASS_NOT_FOUND                                                 syscall.Errno = 15007
	ERROR_EVT_MALFORMED_XML_TEXT                                              syscall.Errno = 15008
	ERROR_EVT_SUBSCRIPTION_TO_DIRECT_CLASS                                    syscall.Errno = 15009
	...
	ERROR_EVT_INVALID_OPERATION_OVER_ENABLED_DIRECT_CLASS                     syscall.Errno = 15022
	ERROR_EVT_INVALID_CLASS_PROPERTY_VALUE                                    syscall.Errno = 15023
	ERROR_EVT_INVALID_PUBLISHER_PROPERTY_VALUE                                syscall.Errno = 15024
	ERROR_EVT_CLASS_CANNOT_ACTIVATE                                           syscall.Errno = 15025
	...
	ERROR_EVT_CANNOT_OPEN_CLASS_OF_QUERY                                      syscall.Errno = 15036
	...
	ERROR_EC_NO_ACTIVE_CLASS                                                  syscall.Errno = 15085
	...
	CO_E_INIT_RPC_CLASS                                                       Handle        = 0x8000400A
	CO_E_INIT_TLS_SET_CLASS_CONTROL                                           Handle        = 0x8000400B
	CO_E_INIT_TLS_CLASS_CONTROL                                               Handle        = 0x8000400C
	...
	PLA_E_PLA_CLASS_NOT_ENABLED                                               Handle        = 0x80300110
	PLA_E_TASKSCHED_CLASS_NOT_ENABLED                                         Handle        = 0x80300111
	...
	ERROR_NDIS_DOT11_AP_CLASS_CURRENTLY_NOT_AVAILABLE                         syscall.Errno = 0x80342005
	ERROR_NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE                          syscall.Errno = 0x80342006
	ERROR_NDIS_DOT11_AP_CLASS_NOT_ALLOWED                                     syscall.Errno = 0x80342007
	...
	WPN_E_CLASS_CLOSED                                                        Handle        = 0x803E0100
	WPN_E_CLASS_REQUEST_NOT_COMPLETE                                          Handle        = 0x803E0101
	WPN_E_INVALID_APP                                                         Handle        = 0x803E0102
	WPN_E_OUTSTANDING_CLASS_REQUEST                                           Handle        = 0x803E0103
	WPN_E_DUPLICATE_CLASS                                                     Handle        = 0x803E0104
	...
	UCEERR_CLASSSYNCTIMEDOUT                                                  Handle        = 0x88980413
	UCEERR_CLASSSYNCABANDONED                                                 Handle        = 0x88980414
	...
	WININET_E_SECURITY_CLASS_ERROR                                            Handle        = 0x80072F7D
